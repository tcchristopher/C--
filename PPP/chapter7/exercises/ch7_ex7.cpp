...
const char help = 'H';                          // for user help			
...
{
    cout << "\n=== Calculator Help ===\n";
    cout << "This calculator supports the following operations:\n\n";
    
    cout << "Basic Operations:\n";
    cout << "  +, -, *, /     : Addition, subtraction, multiplication, division\n";
    cout << "  %              : Modulo (remainder)\n";
    cout << "  ()             : Parentheses for grouping\n\n";
    
    cout << "Functions:\n";
    cout << "  sqrt(x)        : Square root of x\n";
    cout << "  pow(x,i)       : x raised to integer power i\n\n";
    
    cout << "Variables:\n";
    cout << "  # name = expr  : Declare a variable\n";
    cout << "  name = expr    : Assign value to existing variable\n";
    cout << "  const name = expr : Declare a constant (cannot be changed)\n\n";
    
    cout << "Predefined Constants:\n";
    cout << "  k = 1000\n\n";
    
    cout << "Commands:\n";
    cout << "  ;              : Print result (or just press Enter)\n";
    cout << "  exit           : Exit the calculator\n";
    cout << "  help or H or h : Show this help message\n\n";
    
    cout << "Examples:\n";
    cout << "  > 2 + 2;\n";
    cout << "  = 4\n";
    cout << "  > # radius = 5;\n";
    cout << "  > sqrt(radius * radius);\n";
    cout << "  = 5\n";
    cout << "  > const pi = 3.14159;\n";
...
try {
    ...
    cout << "Type 'help' or 'H' for instructions.\n";
